...
if (isset($_POST['user']) and isset($_POST['password'])){
    ...
    if(file_exists('config/users/'.base64_encode($user))){
        $usrTemFile = file_get_contents('config/users/'.base64_encode($user));
...
if (file_exists('doc/index.html')){
    echo '<div align="center"><a href="doc/index.html">Léeme</a></div>';
}
